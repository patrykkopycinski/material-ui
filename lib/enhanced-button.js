...
var EnhancedButton = React.createClass({
  ...
  render: function render() {
    ...
    var other = _objectWithoutProperties(_props, ['centerRipple', 'containerElement', 'disabled', 'disableFocusRipple', 'disableKeyboardFocus', 'disableTouchRipple', 'focusRippleColor', 'focusRippleOpacity', 'linkButton', 'touchRippleColor', 'touchRippleOpacity', 'onBlur', 'onFocus', 'onTouchTap', 'style', 'tabIndex']);
  ...
  _handleFocus: function _handleFocus(e) {
    ...
    if (!this.props.disabled && !this.props.disableKeyboardFocus) {
      ...
      this._focusTimeout = setTimeout(function () {
        if (_this._tabPressed && !_this.state.isKeyboardFocused) {
          _this.setState({ isKeyboardFocused: true });
          if (_this.props.onKeyboardFocus) _this.props.onKeyboardFocus(e, true);
        }
      }, 150);

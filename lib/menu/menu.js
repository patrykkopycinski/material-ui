...
var Menu = React.createClass({
  ...
  _getCurrentHeight: function _getCurrentHeight() {
    var totalItems = Math.max(1, this.props.menuItems.length);
    var styles = this.getStyles();
    var newHeight = styles.item.height * totalItems;
    return newHeight;
  },
    ...
    if (this.props.hideable) {
      (function () {
        ...
        if (_this.props.visible) {
          ...
          el.style.height = _this._getCurrentHeight() + 'px';
          el.style.paddingTop = _this.getSpacing().desktopGutterMini + 'px';
          el.style.paddingBottom = _this.getSpacing().desktopGutterMini + 'px';
